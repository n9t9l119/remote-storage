"""
Django settings for remoteStorage project.
...
SECRET_KEY = 'django-insecure-(6@+e93r+9&8ffshdl%(xh$81emu)ish&@f6z@2q0ag3rb8cl-'
...
WSGI_APPLICATION = 'remoteStorage.wsgi.application'
